...
OUTLINES = [
"""
$wilsonは便利屋$sherlockの許を訪れる。だが$sherlockは$wilsonの話を聞く前から推理で彼の素性や訪問の目的まで全てを言い当て、挙げ句に「王室からの依頼は受けない」と断って覗き窓を閉めてしまう。
困惑する$wilsonは何とか説得しようとするが、その間に子供たちが$carに群がって勝手に触っているのを見つけ、慌てて追い払いに向かう。そこに通りがかった少年$ignesが子供たちを追い払ってくれたが、彼の本当の目的は$wilsonの財布をスることだった。
$sherlockは$ignesに注意し、仕方なく$wilsonを家に入れる。
