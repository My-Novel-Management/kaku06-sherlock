...
$transformした$maryにより、$sherlockは酷い傷を追う。それで正気に戻り、$maryは気絶した。
""",
"""
後日、$sherlockから手紙が届く。そこには$morianoを道連れにしてでも滅ぼす決意と、彼の犯罪関与の証拠とそれについて書いた書類が既に警察に発送されていると記されていた。最後に$maryについての謝罪が書かれていた。
""",
        ]
# TODO
