...
def main(w: World):
    return w.chapter(TITLES[6],
            ...
            w.plot_develop("$morianoにより$limeがさらわれる"),
            w.plot_develop("$sherlockは$morianoの暗号を解いて$limeの監禁場所を探し出す"),
            ...
            w.plot_resolve("$morianoが亡くなっていればその知らせが新聞に掲載されると書かれていた"),
            w.plot_resolve("$morianoの訃報が確認できたが、$sherlockも$morianoも遺体は見つけられなかった"),
            "隣国マイリンゲンのライヘンバッハ",
